...
from app.models.schemas.products_schema import (
    ProductCreateSchema,
    ProductUpdateSchema,
    parse_form,
)
...
async def get_products(
    products_controller: ProductsController = Depends(),
) -> BaseResponse:
...
async def get_product_by_id(
    product_id: str, products_controller: ProductsController = Depends()
) -> BaseResponse:
...
@router.put(
    ...
    dependencies=[Depends(RoleChecker(["admin", "seller"]))],
)
