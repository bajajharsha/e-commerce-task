...
class UserRepository:
    def __init__(self, user_collection: AsyncIOMotorCollection = Depends(database.get_db)):
        ...
        self.product_collection: AsyncIOMotorCollection = database.get_products_collection()
    ...
    async def find_seller(self, product_id: str):
        ...
        product = await self.product_collection.find_one({"_id": str(product_id)}, {"seller_id": 1})
